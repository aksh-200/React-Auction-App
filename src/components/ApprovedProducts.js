 ...
 */}
              ...
              <div className="card shadow-sm p-2 mb-5 bg-white rounded ms-5"  width="100px"  height="270" >
  <div className="card-body">
    <h4 className="card-title">{v.product_name}</h4>
    <h5 className="card-title">Category : {v.category_id.category_name}</h5>
    <h5 className="card-title">Description:{v.description}</h5>
    <h5 className="card-title">Base Price: Rs.  {v.base_price}</h5>
